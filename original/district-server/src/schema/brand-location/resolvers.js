...
const { brandLocationStoreStatus, fulFillmentIcons, brandLocationStoreStatusFull, fulfillmentTypesWithKey, weekDaysTranslate } = require('./enums');
...
module.exports = {
  BrandLocation: {
    ...
    async tags({ id }, args, context) {
      return context.tagRelation.loaders.getTagsByRelId.load(id);
    },
