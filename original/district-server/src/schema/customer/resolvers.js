...
module.exports = {
  Customer: {
    ...
    async lockedDownStatusForOTP({ phoneNumber }, args, context) {
      if (!phoneNumber) {
        return {
          'hitCount': -1,
          'lockedDown': false
      ...
      return context.customer.loaders.customerOTPLockdownStatus.load(phoneNumber);
    },
    ...
    async defaultPaymentMethod({ id }, { currencyId }, context) {
      return context.customer.getLastPaymentMethod({ id, currencyId });
    }
  },
};
