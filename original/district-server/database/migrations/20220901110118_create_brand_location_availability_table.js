...
exports.up = function (knex) {
    return knex.schema.createTable('brand_location_availabilities', table => {  
        ...
        table
            ...
            .notNullable()
            .defaultTo(knex.fn.now());   
    }).then(() => knex.raw(onUpdateTrigger('brand_location_availabilities')));
};
  
exports.down = async function (knex) {
    await knex.schema.dropTable('brand_location_availabilities');
};