...
let _firebaseConfig = { ...config.firebaseConfig };
const jwtDecode = require('jwt-decode');
const { transformToSnakeCase } = require('./util');
const admin = require('firebase-admin');
_firebaseConfig.privateKey = _firebaseConfig.privateKey.replace(/\\n/gi, '\n');
_firebaseConfig = transformToSnakeCase(_firebaseConfig);
let auth = null;
try {
  admin.initializeApp({
