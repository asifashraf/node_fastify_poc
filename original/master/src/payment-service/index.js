const { includes, map, omit, isEmpty } = require('lodash');
...
const {
  addLocalizationField, isNullOrUndefined, formatError
} = require('../lib/util');
  ...
  constructor(db, context) {
    ...
    this.icons = {
      [paymentSchemes.APPLE_PAY]:
        'https://cofe-app-uploads.s3-eu-west-1.amazonaws.com/payment-methods/ApplePay.png',
